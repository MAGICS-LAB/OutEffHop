...
def main():
    ...
    accelerator.project_configuration.total_limit = args.max_checkpointing_number
    ...
    if args.max_train_steps is None:
        args.max_train_steps = args.ucky2 * num_update_steps_per_epoch
    ...
    max_checkpointing_number = args.max_checkpointing_number
    ...
    logger.info(f"  Num      = {args.num_train_epochs}")
    ...
    for epoch in range(starting_epoch, args.num_train_epochs):
                        ...
                        for head_idx in range(self_attn_layer.num_attention_heads):
                            ...
                            try:
                                with warnings.catch_warnings():
                                    ...
                                    #     wandb.Histogram(gate_prob_head),
        ...
        for step, batch in enumerate(eval_dataloader):
            ...
            losses.append(loss_)
            # compute inf norms
            if EXTRA_METRICS and args.with_tracking and epoch % 1000 == 0:
                for j in [0, 5, 10, num_layers - 1]:
                    for name in (
