...
This is the code of the paper [Outlier-Efficient Hopfield Layers for Large Transformer-Based Models](https://arxiv.org/abs/2404.03828). You can use this repo to reproduce the results in the paper.
