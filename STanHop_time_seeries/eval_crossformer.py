...
from cross_exp.exp_stanhop import Exp_Stanhop
...
mae, mse, rmse, mape, mspe, Inf_norm_output, kurtosis_output, kurtosis_output_mean = exp.eval(args.setting_name, args.save_pred, args.inverse)
...
log_file.write('Inf_norm_output:{}\n'.format(Inf_norm_output))
log_file.write('kurtosis_output:{}\n'.format(kurtosis_output))
log_file.write('kurtosis_output_mean:{}\n'.format(kurtosis_output_mean))
log_file.close()
