...
parser.add_argument('--mode', type=str, default='entmax', help='entmax or softmax')
parser.add_argument('--run_name', type=str, default='STHM_entmax', help='name of wandb')
parser.add_argument('--eta', type=float, default=1.1, help='eta of entmax')
parser.add_argument('--gamma', type=float, default=-0.1, help='gamma of entmax')
